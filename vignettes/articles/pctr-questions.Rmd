...
> We could remove `pctr_companies_new$ei_activity` and
`pctr_companies_new$unit`. But this would then affect the join between company
data and ecoinvent data, which then would only need to be done by =
"activity_product_uuid" -- Tilman
