...
data_ecoinvent <- read_csv(product_carbon_tr_path("input_data", "ecoinvent_activities.csv"))
```
...
``` {r}
# load sample data
data_companies <- read_csv(product_carbon_tr_path("input_data", "MVP_sample_dataset.csv"))
...
dir_create(product_carbon_tr_path("output_data"))
write_csv(company_scores, product_carbon_tr_path("output_data", "mvp_product_carbon_tr_output.csv"))
```
