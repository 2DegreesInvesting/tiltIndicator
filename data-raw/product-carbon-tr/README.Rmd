...
data_ecoinvent <- read_csv(pctr_path("input_data", "ecoinvent_activities.csv"))
```
...
``` {r}
# load sample data
data_companies <- read_csv(pctr_path("input_data", "MVP_sample_dataset.csv"))
...
dir_create(pctr_path("output_data"))
write_csv(company_scores, pctr_path("output_data", "mvp_pctr_output.csv"))
```
