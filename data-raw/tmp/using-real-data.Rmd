...
> The dataset has `NA`s for all rows in `company_name`. This shouldn't be the
case. `score_aggregated` is also `NA`.

TODO: Peer-program with Tilman to develop a new version of the PSTR functions
that takes the new data structure.
