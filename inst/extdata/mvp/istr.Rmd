...
```{r}
reshaped_istr_companies <- glimpse(tiltIndicator::istr_companies)

istr_ep_weo <- glimpse(tiltIndicator::istr_ep_weo)

istr_weo_2022 <- glimpse(tiltIndicator::istr_weo_2022)
```
