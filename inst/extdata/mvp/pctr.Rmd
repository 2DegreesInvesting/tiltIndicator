...
pctr_step1 <- function(ecoinvent_co2) {
...
ecoinvent_ranks <- pctr_step1(ecoinvent_co2)
ecoinvent_ranks
```
...
```{r}
pctr_step2 <- function(companies, ecoinvent_scores) {
...
pctr_output <- pctr_step2(companies, ecoinvent_scores)
pctr_output
```
